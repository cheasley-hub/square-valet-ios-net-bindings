...
namespace SquareValetBindings {
	[Register("VALSecureEnclaveValet", true)]
	public unsafe partial class VALSecureEnclaveValet : NSObject {
		...
		protected VALSecureEnclaveValet (NSObjectFlag t) : base (t)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal VALSecureEnclaveValet (NativeHandle handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
